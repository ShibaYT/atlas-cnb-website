    ...
    <footer id="contact" className="scroll-mt-20 border-t border-border bg-card">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="grid gap-12 lg:grid-cols-[1.5fr_1fr_1fr]"
        >
          {/* Brand */}
          <div>
            <div className="flex items-center gap-3">
              <div className="relative h-12 w-12 overflow-hidden rounded-full border-2 border-gold/30 bg-background">
                <Image
                  src="/atlas-logo.jpeg"
                  alt="Atlas CNB logo"
                  fill
            ...
            <p className="mt-4 max-w-sm text-sm text-muted-foreground">
              ...
              of innovation and inspiring the next generation of engineers.
            </p>
          ...
          {/* Quick links */}
          <div>
            <h3 className="font-serif text-sm font-semibold uppercase tracking-wider text-card-foreground">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <div className="mt-4 space-y-4 text-sm text-muted-foreground">
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:contact@atlascnb.ro" className="transition-colors hover:text-gold">
                  contact@atlascnb.ro
                </a>
              </div>
              <div className="flex items-start gap-3">
        ...
        <div className="mt-12 border-t border-border pt-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <p className="text-xs text-muted-foreground">
              FIRST Tech Challenge Robotics Team &middot; Timisoara, Romania
            </p>
          </div>
        </div>
      </div>
